	...
	*/
	...
	function generate_pagination($total_rows, $url, $limit, $page, $extraparams = "") {
		...
		if($lastpage > 1) {
			...
			//previous button
			if ($page > 1)
				$pagination.= "<li><a href='".$targetpage.$pre_str."page=".$prev.$params."'><i class='fa fa-angle-left'></i>Prev</a></li>";
			else
				$pagination.= "<li><a class=\"disabled\"><i class='fa fa-angle-left'></i>Prev</a></li>";
			//pages
			...
			if ($page < $counter - 1)
				$pagination.= "<li><a href='".$targetpage.$pre_str."page=".$next.$params."'><i class='fa fa-angle-right'></i>Next</a></li>";
			else
				$pagination.= "<li><a class=\"disabled\"><i class='fa fa-angle-right'></i>Next</a></li>";
